...
public class ExamController
{
	...
	@RequestMapping(value = "/TakeTest1", method = RequestMethod.POST)
	public String TakeTest1(@RequestBody String requestBody) throws Exception {
		 JSONObject jsonObject = new JSONObject(requestBody);
	        
	        // Retrieve the value of previousTime1
	        int previousTime = jsonObject.getInt("previousTime");
	        System.out.println("Previous Time: " + previousTime);
	        int ceID= jsonObject.getInt("ceID");
	        System.out.println("ceID : " + ceID);
	        int userID= jsonObject.getInt("userID");
	        System.out.println("userID : " + userID);
	        int fkItemId= jsonObject.getInt("fkItemId");
	        System.out.println("fkItemId : " + fkItemId);
			candidateExamServiceImpl.insertItemDetails(previousTime,ceID,userID,fkItemId);
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) {
        // Retrieve the value of timeBetweenQuestions parameter from the request
        int timeBetweenQuestions = Integer.parseInt(request.getParameter("timeBetweenQuestions"));

        // Store the value in the session
        HttpSession session = request.getSession();
        session.setAttribute("timeBetweenQuestions", timeBetweenQuestions);
    }
}
