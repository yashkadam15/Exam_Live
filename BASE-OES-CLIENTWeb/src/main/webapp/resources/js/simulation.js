...
var closewithsave = function(val) {
	alert("Alert is here")
	console.log("Inside closewithsave");
	closeModel();
	console.log("After closeModel");
	updateTimeDifferenceDisplay();
	console.log("After updateTimeDifferenceDisplay");
  ...
  function calculateTimeDifference() {
  	console.log("Inside calculateTimeDifference");
  ...
  // Example usage:
  // Call this function whenever a new question is attempted
  //var timeBetweenQuestions = calculateTimeDifference();
  //console.log("Last Attempted Question time is : " + timeBetweenQuestions + " seconds");
  // Function to update the time difference display on the page
  function updateTimeDifferenceDisplay() {
  	console.log("Inside updateTimeDifferenceDisplay");
      var timeBetweenQuestions = calculateTimeDifference();
      	console.log("After  calling calculateTimeDifference");
      var displayElement = document.getElementById('timeDifferenceDisplay');
      console.log("time difference",timeBetweenQuestions)
      if (displayElement) {
          displayElement.innerText = "Last Attempted Question Time: " + timeBetweenQuestions + " seconds";
      } else {
          console.error("Element with ID 'timeDifferenceDisplay' not found.");
      }    
  };
