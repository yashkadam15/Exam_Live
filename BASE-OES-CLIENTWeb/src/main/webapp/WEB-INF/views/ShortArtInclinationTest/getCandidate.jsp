...
<body>
	<legend>
		<span><spring:message code="artInclination.report"></spring:message></span>
	</legend>
	<div class="holder">
		<form:form class="form-horizontal"  action="artInclinationTestReport" method="GET" onsubmit="return validate(this);" target="_blank">
...
<script type="text/javascript">
	function validate(form) {
		...
		if(e['candidateUserName'].value=="")
		{
			...
			alert('<spring:message code="artInclination.username"/>');
			return false;
		}
		return true;
	}
