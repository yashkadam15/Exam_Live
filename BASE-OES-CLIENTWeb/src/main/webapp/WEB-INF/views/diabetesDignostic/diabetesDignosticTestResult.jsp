	...
	<div class="pageborder" >
		...
		<div style="width: 100%;height:150px; font-weight:bold;vertical-align: middle;">
			...
			<div style="text-align:center;width:100%;">
				<h2 style="padding-top: 30px;"><u><spring:message code="diabetesDiagnosticTestResult.healthPrgm"/></u></h2>
			</div>
		...
		<div style="width: 70%; border: solid #C7C9CB 3px;padding: 10px; border-radius: 15px;font-size:13;text-align: left; margin-top: -35px;">
			<b><spring:message code="diabetesDiagnosticTestResult.participantName"/></b> ${candidateExam.candidate.candidateFirstName} ${candidateExam.candidate.candidateMiddleName}  ${candidateExam.candidate.candidateLastName}
			<br><b><spring:message code="diabetesDiagnosticTestResult.centerCode"/></b> ${candidateExam.examVenue.examVenueCode}
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b><spring:message code="diabetesDiagnosticTestResult.centerName"/></b> ${candidateExam.examVenue.examVenueName}
			<br><b><spring:message code="diabetesDiagnosticTestResult.district"/></b> ${candidateExam.examVenue.examVenuePinCode}
		</div>
		</center>
		<br>
		<br>
		<br>
		<div style="width: 100%;font-weight: bold;"><spring:message code="diabetesDiagnosticTestResult.instruAccordingToGivenAns"/></div>
					...
					<c:forEach items="${candidateSuggestionViewModelList}" var="sm">						
						...
						<c:if test="${sm.suggestionMaster.fkCategoryID == category.categoryID}">
							<c:if test="${firstEle=='1'}">
								<!-- <br> -->
								<p style="width: 100%;text-decoration: underline;font-weight: bold;"><b>${category.categoryName}</b></p>
								<c:set var="firstEle" value="0"></c:set>
							</c:if>
							<ul type="square" style="padding-left:15px;"><li>${sm.suggestionMaster.suggestionText} </li></ul>
						</c:if>
					</c:forEach>
			</c:forEach>
			
			<br><br>
			<div style="width: 100%;padding-bottom: 40px;"><b><spring:message code="diabetesDiagnosticTestResult.disclaimer"/></b> <spring:message code="diabetesDiagnosticTestResult.activityMsg"/></div>
