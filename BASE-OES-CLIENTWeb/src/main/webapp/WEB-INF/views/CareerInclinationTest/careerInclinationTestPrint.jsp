...
<c:choose>
	...
	<c:otherwise>
		...
		<div style="margin-left: 5%; margin-right: 5%;">
							...
							<td style="vertical-align: top;">
							 ...
							 <jsp:useBean id="now" class="java.util.Date"></jsp:useBean>
								<fmt:formatDate value="${now}" pattern="dd/MM/yyyy" var="currentDateValue" /> 
									<table>
									<tr>
										<td><spring:message code="careerInclination.studentName"></spring:message></td>
										<td>:&nbsp;</td>
										<td>${canExam.candidate.candidateFirstName}&nbsp;${canExam.candidate.candidateLastName}</td>
									</tr>
									
									<tr>
										<td><spring:message code="careerInclination.candidateCode"></spring:message></td>
										<td>:&nbsp;</td>
										<td>${canExam.candidate.candidateCode}</td>
									</tr>
									
									<tr>
										<td><spring:message code="careerInclination.attemptDate"></spring:message></td>
										<td>:&nbsp;</td>
										<td><fmt:formatDate value="${canExam.attemptDate}" pattern="dd/MM/yyyy"/></td>
									</tr>
									<tr>
										<td><spring:message code="careerInclination.centerCode"></spring:message></td>
										<td>:&nbsp;</td>
										<td>${canExam.examVenue.examVenueCode}</td>
									</tr>
									<tr>
										<td><spring:message code="careerInclination.centerName"></spring:message></td>
										<td>:&nbsp;</td>
										<td>${canExam.examVenue.examVenueName}</td>
									</tr>
								</table>
			...
			<label  style="font-size:11pt;"><spring:message code="careerInclination.courseTrailorLink"></spring:message></label>
			
			<p style="color:#6666FF;"> <spring:message code="careerInclination.elearningmkclorgklic"></spring:message> <p/>
			<br/>
			<p style="font-size: 9.5px; line-height:normal;"><b><spring:message code="careerInclination.disclaimer"></spring:message></b><spring:message code="careerInclination.disclaimerText"></spring:message></p>
			...
			<div style="margin-right: 5%;" align="center;">
				<center><button id="printbtn" class="btn btn-success"><spring:message code="careerInclination.print"></spring:message></button></center>
			</div>
