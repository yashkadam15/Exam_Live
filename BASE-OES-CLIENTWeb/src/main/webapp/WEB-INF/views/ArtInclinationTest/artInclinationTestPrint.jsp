...
<c:choose>
	...
	<c:otherwise>
		...
		<div style="margin-left: 5%; margin-right: 5%;">
							...
							<td style="vertical-align: top;">
							 <jsp:useBean id="now" class="java.util.Date"></jsp:useBean>
								<fmt:formatDate value="${now}" pattern="dd/MM/yyyy" var="currentDateValue" /> 
									<table>
									<tr>
										<td><spring:message code="artInclination.studentName"></spring:message></td>
										<td>:&nbsp;</td>
										<td>${artObj.candidateFirstName}&nbsp;${artObj.candidateLastName}</td>
									</tr>
									
									<tr>
										<td><spring:message code="artInclination.candidateCode"></spring:message></td>
										<td>:&nbsp;</td>
										<td>${artObj.candidateCode}</td>
									</tr>
									
									<tr>
										<td><spring:message code="artInclination.attemptDate"></spring:message></td>
										<td>:&nbsp;</td>
										<td><fmt:formatDate value="${artObj.attemptDate}" pattern="dd/MM/yyyy"/></td>
									</tr>
									<tr>
										<td><spring:message code="artInclination.centerCode"></spring:message></td>
										<td>:&nbsp;</td>
										<td>${artObj.examVenueCode}</td>
									</tr>
									<tr>
										<td><spring:message code="artInclination.centerName"></spring:message></td>
										<td>:&nbsp;</td>
										<td>${artObj.examVenueName}</td>
									</tr>
								</table>
			...
			<label  style="font-size:11pt;"><spring:message code="artInclination.courseTrailorLink"></spring:message></label>
			
			<p style="color:#6666FF;"><u><a href="http://www.mkcl.org/klic/" target="_blank"><spring:message code="artInclinationTest.wwwmkcorgklic"></spring:message></a></u> <p/>
			<br/>
			<p style="font-size: 9.5px; line-height:normal;"><b><spring:message code="artInclination.disclaimer"></spring:message></b><spring:message code="artInclination.disclaimerText"></spring:message></p>
			...
			<div style="margin-right: 5%;" align="center;">
				<center><button id="printbtn" class="btn btn-success"><spring:message code="artInclination.print"></spring:message></button></center>
			</div>
