...
<body>
	...
	<fieldset class="well">
		...
		<legend>
		    ...
		    <c:if test="${currentExamEvent.eventCategory == 'TestSeries' }">
		       <span class="pull-right"><spring:message code="homepage.testendson" /><fmt:formatDate pattern="${dateFormatForAllPapers}" value="${currentExamEvent.endDate}" /></span>
		    </c:if>	
		</legend>
		...
		<div class="holder">
			...
			<div id="tabbable">
				<ul class="nav nav-tabs" id="myTab">
					...
					<c:if test="${currentExamEvent.localSchedular == 'Candidate' }">
						<li><a href="../candidateModule/reattempthomepage" class="tab_text" style="text-transform: uppercase; font-weight: normal; text-shadow: 1px 1px 0 #ffffff;"><spring:message code="homepage.reattemTab" /></a></li>
					</c:if>
				</ul>
			</div>
