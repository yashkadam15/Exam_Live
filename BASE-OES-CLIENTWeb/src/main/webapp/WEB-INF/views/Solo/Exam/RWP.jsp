...
<input type="hidden" id="dbanscnt" name="dbanscnt" value="${examViewModel.openObject}"/>
	...
	<form:hidden path="item.Itemtype" value="RWP" id="itype"/>
         	...
         	<c:choose>
         		<c:when test="${selectedLang == item.itemLanguage.fkLanguageID}">
         			<div id="${item.itemLanguage.fkLanguageID}" class="qdiv">
		              	   <p class="question-wrap"><spring:message code="rwp.maintext"></spring:message></p>
		              	 ...
		              	 <div id="longtextanswer">
		              	  	...
		              	  	<form:textarea path="candidateAnswers[0].typedText" autoComplete="off" autoCorrect="off" autoCapitalize="off" onpaste="return false;" onselectstart="return false" spellCheck="false" class="form-control answerdata markdown" id="optionsAns"></form:textarea>
