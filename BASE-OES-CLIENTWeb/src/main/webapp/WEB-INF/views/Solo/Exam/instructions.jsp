...
<c:forEach var="association" items="${candidateItemAssociations}">
    <!-- Accessing the itemStatus property -->
    <c:set var="status" value="${association.itemStatus}" />
     <c:if test="${association.itemStatus eq 'Answered'}">
    ...
    <div class="modal-dialog" role="document" >
        <div class="modal-content" >
            ...
            <div class="modal-body">
                            <!-- Display in the modal body -->
                            <ul>
                                    <li><p>Exam Start Date-Time: <span>${examStartDate}</span></p></li>
                                    <li><p>Time Left to Complete Exam in Minute-Seconds: <span>${timeLeft} </span></p></li>
                                    <li><p>Total Questions: <span> ${fn:length(candidateItemAssociations)}</span></p></li>
                                    <li><p>Your Solved Questions: <span> ${answeredCount}</span></p></li>
                                   
                            </ul>	
                <b><h5>Are you sure you want to proceed to the test?</h5></b>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
                <button type="button" class="btn btn-success" id="confirmModalBtn">Start Exam</button>
            </div>
        </div>
    </div>
</div>
	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
		    ...
		    $("#confirmModalBtn").click(function() {
		        ...
		        $("#readyToBeginForm").submit();
		    });

		    console.log('sessionScopePrint', $(sessionScope))
		});
