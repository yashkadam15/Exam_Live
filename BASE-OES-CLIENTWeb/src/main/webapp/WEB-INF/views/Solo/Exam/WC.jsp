...
<body class="exampage exampage-hgt" onload="loadWords();">
...
<input type="hidden" id="dbanscnt" name="dbanscnt" value="${examViewModel.openObject}"/>
	...
	<input type="hidden" id="curitemID" name="curitemID" value="${examViewModel.wordCloudList[0].itemLanguage.item.itemID }" />
	...
	<form:hidden path="item.Itemtype" value="WC" id="itype"/>
	...
	<input type="hidden" id="isLastItem" value="${candidateItemAssociation.isLastItem}">
      ...
      <div class="question">
          ...
          <c:choose>
          	<c:when test="${examViewModel != null && examViewModel.wordCloudList != null && fn:length(examViewModel.wordCloudList) > 1}">
          		<div class="pull-right">
              ...
              <spring:message code="Exam.ViewIn" />
               <select id="viewLang"> 
              <c:forEach items="${examViewModel.wordCloudList }" var="item" varStatus="i">
              	<c:choose>
         	...
         	<c:choose>
         		<c:when test="${selectedLang == item.itemLanguage.fkLanguageID}">
         			<div id="${item.itemLanguage.fkLanguageID}" class="qdiv">
		              	 ...
		              	 <div id="wcDiv" data-text="${item.wordClouds }" style="width: 100%; background-color: #fff;">
		              	 </div>    
									...
									<form:hidden path="candidateAnswers[0].typedText" id="optionsAns"/>         	       	  
