...
<input type="hidden" id="dbanscnt" name="dbanscnt" value="${examViewModel.openObject}"/>
	...
	<form:hidden path="item.Itemtype" value="FQFA" id="itype"/>
         	...
         	<c:choose>
         		<c:when test="${selectedLang == item.itemLanguage.fkLanguageID}">
         			<div id="${item.itemLanguage.fkLanguageID}" class="qdiv">
		              	 <p class="question-wrap"><spring:message code="fqfa.maintext"></spring:message></p>
		              	 ...
		              	 <c:if test="${item.itemImage != null && item.itemImage != ''  && fn:length(item.itemImage) > 0}">
		              	  ...
		              	  <div id="longtextanswer">
		              	  	<span><span id="charText"><spring:message code="fqfa.totalWordCount"/></span>&nbsp;<span id="charCount">0</span></span>
		              	  	<form:textarea path="candidateAnswers[0].typedText" autoComplete="off" autoCorrect="off" autoCapitalize="off" onpaste="return false;" onselectstart="return false" spellCheck="false" class="form-control answerdata" id="optionsAns" cols="1" maxlength="2000"></form:textarea>
		              	 </div>          	
         		...
         		<%-- <c:otherwise>
         			<div id="${item.itemLanguage.fkLanguageID}" class="qdiv">
		              	 ...
		              	 <br/>
		              	     <form:textarea path="candidateAnswers[0].typedText" class="form-control" id="answerdata_EC" name="answerdata" rows="1" style="width: 526px;"></form:textarea>         	
		              	            <form:hidden path="candidateAnswers[0].candidateExamItemID" />
									<form:hidden path="candidateAnswers[0].fkcandidateID" />
									<form:hidden path="candidateAnswers[0].fkItemID" />
									<form:hidden path="candidateAnswers[0].candidateAnswerID" />
