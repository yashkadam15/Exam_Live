...
<html>
<head>
<title>Future Vedh (दिशा शोध चाचणी) Report</title>
...
<table cellpadding="0" cellspacing="0" border="0" width="100%">
	<tr>
		...
		<td><img src="<c:url value="../resources/images/headerbanner.JPG"></c:url>" alt=""></td>
	</tr>
</table>
	...
	<div class="holder">
			...
			<center><img src="<c:url value="../resources/images/Logo_strip.jpg"></c:url>" alt=""></center>
