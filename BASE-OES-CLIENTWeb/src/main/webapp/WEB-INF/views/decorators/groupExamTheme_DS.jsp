...
<body class="osp exam digital-school">
	<div class="main">
		...
		<div class="osp-header">
			<div class="container">
				<div class="row">
					<div class="span12">
						<div class="holder">
							<img class="oes-logo pull-left" src="<c:url value="../resources/images/logo-inner.png"></c:url>" alt="" style="width: 9%"> ${paper.name }<img class="mkcl-logo pull-right" style="width: 3%" src="<c:url value= "../resources/images/companylogo.png"></c:url>" alt="">
						</div>
