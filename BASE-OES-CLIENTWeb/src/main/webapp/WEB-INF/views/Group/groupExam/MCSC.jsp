...
<form:form action="ProcessQuestion" method="POST" id="frmQues" modelAttribute="candidateItemAssociation">
	...
	<input type="hidden" id="curitemID" name="curitemID" value="${examViewModel.multipleChoiceSingleCorrects[0].itemLanguage.item.itemID }" />
	...
	<form:hidden path="item.Itemtype" value="MCSC"/>
...
<div class="osp-question" >
    ...
    <div class="osp-question-holder">
     <!-- Language Select Box -->
              ...
              <c:forEach items="${examViewModel.multipleChoiceSingleCorrects }" var="item" varStatus="i">
              	<c:choose>
