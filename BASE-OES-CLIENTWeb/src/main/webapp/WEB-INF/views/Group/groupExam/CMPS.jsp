         			...
         			<div id="${item.itemLanguage.fkLanguageID}" class="qdiv">
         			    ...
         			    <div class="cq-holder clearfix">
         			        <div class="left-holder">
                          		<div class="comprehension osp-comprehension scrollbar-outer">
         			        ...
         			        <div class="right-holder">
         			           	<div class="cmpsqdiv comprehension-Questions osp-comprehension-Questions scrollbar-outer">
         		...
         		<c:otherwise>
         			<div id="${item.itemLanguage.fkLanguageID}" class="qdiv">
	         			 ...
	         			 <div class="cq-holder clearfix">
	         			        ...
	         			        <div class="right-holder"> 
	         			           	<div class="cmpsqdiv comprehension-Questions">
