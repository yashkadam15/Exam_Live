...
<body>
	<div style="padding-top: 25px; padding-left: 25px; align-self: center;">
		<p style="font-size: 22px; color: #E47911;"><spring:message code="http404.lookSomething"/>
		</p>
		<br>

		<p style="font-size: 16px; color: #999999;"><spring:message code="http404.addressNotFunctioning"/></p>
