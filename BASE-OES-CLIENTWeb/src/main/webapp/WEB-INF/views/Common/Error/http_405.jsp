...
<div style="padding-top: 25px; padding-left:25px;align-self: center;">
     <p style="font-size: 20px;color: #E47911;">
          <spring:message code="http405.methodNotAllowed"/>
        </p><br>
     
          <p style="font-size: 16px;color: #999999;"> <spring:message code="http405.pageRefreshed"/> </p>
