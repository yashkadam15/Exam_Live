...
<body>
	<fieldset class="well">
		<div>
			<legend>
				<span><spring:message code="certificate.typinglabel"/></span>
			</legend>
		</div>
		
		<div class="holder">
			<form:form  class="form-horizontal"  action="EligibilityCerticateCandidatelist" method="post" onsubmit="return validate();">
